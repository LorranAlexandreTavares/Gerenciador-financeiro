...
const App = () => {
  ...
  const filteredTransactions = useMemo(() => {
    return transactions.filter(t => {
      ...
      // Adjust for timezone issues by comparing month and year
  ...
  const summary = useMemo((): FinancialSummary => {
    ...
    const currentDay = isCurrentMonth ? now.getDate() : daysInMonth; // If not current month, assume whole month passed for budget calc
        ...
        return (
          <div className="space-y-6 animate-fade-in">
            <div className="bg-rose-500 p-6 rounded-3xl text-white shadow-lg">
              <p className="opacity-90 font-medium">Total Variável</p>
            ...
            <HistoryList title="Despesas Variáveis" transactions={variableTransactions} onDelete={handleDeleteTransaction} onEdit={handleEditTransaction} />
          </div>
        );
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex justify-between items-center mb-4">
                ...
                <button 
                  ...
                  className="text-sm bg-black text-white px-3 py-1.5 rounded-lg font-medium hover:bg-gray-800 transition-colors"
                >
                    + Nova Meta
                </button>
            </div>
